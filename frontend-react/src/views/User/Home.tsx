...
const Home: React.FC = () => {
    ...
    const handleCategoryProduct = (categoryId: number) => {
        navigate(`/user/products/list?categoryId=${categoryId}`);
    }
                        ...
                        {categories.map((cat, index) => (
                            ...
                            >
                                ...
                                <div className="p-6 text-center">
                                    ...
                                    {/* Bouton d'action */}
                                    <button onClick={() => handleCategoryProduct(Number(cat.id))} className="mt-5 px-5 py-2 bg-transparent border border-blue-500 text-blue-600 rounded-lg font-medium transition-all duration-300 group-hover:bg-blue-500 group-hover:text-white">
                                        Voir les produits
